...
![dither.studio](public/og.png)

*The card above is not a mockup: it is generated by `npm run og`, which
thresholds a procedurally lit sphere against an 8x8 Bayer matrix in Node. Same
