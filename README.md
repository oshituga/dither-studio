...
**[Open it →](https://dither-studio-ayo.vercel.app)**

![A dithered sphere in two tones, Bayer 4, at a 420px grid](docs/hero.png)

*Straight out of the tool: the plate it opens on, 420px grid, two tones,
Bayer 4. The link card is generated the same way — `npm run og` thresholds a
procedurally lit sphere against an 8x8 matrix in Node, so it cannot go stale
